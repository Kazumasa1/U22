...
public class Main {
	public static void main(String[] args) {
        ...
        // テキストペアへ渡すJSON文字列
        //  String JSON = "{\"app_id\":\"***REMOVED***\", \"request_id\":\"u22\", \"text1\":\"高橋さんはアメリカに出張に行きました。\", \"text2\":\"山田さんはイギリスに留学している。\"}"; 
         String JSON = "{\"app_id\":\"***REMOVED***\", \"request_id\":\"u22\", \"text1\":\"" + text1 + "\", \"text2\":\"" + text2 + "\"}"; 
        // テキストペアへ
